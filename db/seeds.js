  ...
  .then((users) => {
    ...
    return Project
      .create([{
        ...
        description: 'Final Frontier is a website created for the amateur and professional astrophotography community. It is similar to Instagram, but purely for images for stars, galaxies, nebulas, planets, auroras, comets/astroids and the night sky in general',
        projectUrl: 'https://pacific-taiga-22359.herokuapp.com/',
        image: '/images/final_frontier.png',
        ...
        title: 'Hue Hunter',
        description: 'Hue Hunter is a simply colour game which requires the user to sort an array of colours into the correct gradient between two end colours. My aim was to build a game that visually looked stunning, as well as be able to function effectively. I went for a minimalistic look with clean lines and bright colours. There are two game modes, easy and hard, which incrementally increase the number of gradient colours that must be sorted to continue to the next round.',
        projectUrl: 'https://salty-brook-68142.herokuapp.com/',
        image: '/images/hue_hunter.png',
        dateCreated: '2017-05-20',
        tech: ['Git', 'Gulp', 'npm', 'Heroku', 'Jquery', 'HTML5', 'SASS', 'JavaScript'],
        createdBy: users[0]
      },{
